#!/usr/bin/env python3
"""Quick demo script — test Google Calendar OAuth without full setup.

This is a minimal standalone script to verify OAuth works before integrating
with the full BookAppt.ai system.
...
Usage:
  ...
  3. Run: python demo_oauth_test.py
  4. Visit http://localhost:5001 in your browser
  5. Click "Connect Calendar" and complete OAuth
  6. See your upcoming events listed

This does NOT require the full app or voxlayer — just tests calendar access.
"""
...
def home():
    if "credentials" not in session:
        ...
        <body style="font-family: sans-serif; max-width: 600px; margin: 100px auto;">
            ...
            <ol>
                ...
                <li>Redirect URI: <code>http://127.0.0.1:5001/callback</code></li>
    ...
    # User is logged in — show calendar info
    ...
    if busy_blocks:
        ...
        busy_html = "<p><em>No busy blocks in next 7 days (you're completely free!).</em></p>"
...
GOOGLE_CLIENT_SECRET=GOCSPX-your-secret
            ...
            <ol>
                ...
                <li>Add redirect URI: <code>http://127.0.0.1:5001/callback</code></li>
...
if __name__ == "__main__":
    ...
    print()
    print("  Make sure you have in app/.env:")
    print("    GOOGLE_CLIENT_ID=...")
    print("    GOOGLE_CLIENT_SECRET=...")
    print()
    print("  Redirect URI to add in Google Console:")
    print("    http://127.0.0.1:5001/callback")
    print()
    print("=" * 60)
    print()
